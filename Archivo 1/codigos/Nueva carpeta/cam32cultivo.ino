...
const char* ssid = "Punto de acceso 015";
const char* password = "s1n espacio";
 
// Initialize Telegram BOT
String BOTtoken = "6790188639:AAHy-MWFQX2T4P_4lRiYgeydfhIYXdVtznU";  // your Bot Token (Get from Botfather)
 
// Use @myidbot to find out the chat ID of an individual or a group
// Also note that you need to click "start" on a bot before it can
// message you
String CHAT_ID = "-1002129289117";
...
unsigned int pictureNumber = 0;//cantidad de fotos 
...
void handleNewMessages(int numNewMessages) {
  ...
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (text == "/start") {
      ...
      welcome += "/photo : Toma una foto\n";
     // welcome += "/flash : enciende o apaga el LED flash\n";
      bot.sendMessage(CHAT_ID, welcome, "");
    }
 /*   if (text == "/flash") {
      flashState = !flashState;
      digitalWrite(FLASH_LED_PIN, flashState);
      Serial.println("Cambio de estado del LED flash");
    }*/
    if (text == "/photo") {
      sendPhoto = true;
